...
@user.route('/pg_ads')
def pg_ads():
    data = mysql_query("Select pg_mst.pg_name,pg_mst.addr_1,pg_mst.addr_2,pg_mst.pg_gender,pg_mst.area,pg_mst.city,pg_mst.state,pg_mst.pincode,pg_mst.total_rooms,pg_mst.prop_desc,user_mst.email from pg_mst inner join user_mst on pg_mst.uid=user_mst.uid")
